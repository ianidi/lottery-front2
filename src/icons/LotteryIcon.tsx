...
export const LotteryIcon = createIcon({
  displayName: 'LotteryIcon',
  path: (
    <>
      <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M26.511,12.004L6.233,0.463c-2.151-1.228-4.344,0.115-4.344,2.53v24.093
