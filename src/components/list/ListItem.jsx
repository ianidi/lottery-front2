...
export const ListItem = ({ play, item, accountString, item: { lotteryID, liquidity, formula, maxBetPercent, member, duration, tokenName, tokenSymbol, tokenDecimals } }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Flex justify="center">
          <Text my="auto" align="center">{lotteryID}</Text>
        </Flex>
        <Flex justify="center">
